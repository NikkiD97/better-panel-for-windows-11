...
Better Panel discovers the Details pane through Explorer lifecycle hooks instead
of occupying Explorer's single XAML Diagnostics connection. It can run beside
Windows 11 File Explorer Styler on the tested Windows 11 25H2 system.
